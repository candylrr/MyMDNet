...
[net_conv, net_fc, opts] = mdnet_initnobranch(img, net);
...
%{
est=fopen('est.txt','a');
predata=fopen('preata.txt','a');
netupdate=fopen('netupdate.txt','a');
esttimetotal=0;
predatatimetotal=0;
netupdatetimetotal=0;
%}
draw=fopen('/home/lrr/workspace/MDNet-master/time/draw.txt','a');
evaluate=fopen('/home/lrr/workspace/MDNet-master/time/evaluate.txt','a');
extend=fopen('/home/lrr/workspace/MDNet-master/time/extend.txt','a');
bbox=fopen('/home/lrr/workspace/MDNet-master/time/bbox.txt','a');
drawtimetotal=0;
evaluatetimetotal=0;
extendtimetotal=0;
bboxtimetotal=0;
